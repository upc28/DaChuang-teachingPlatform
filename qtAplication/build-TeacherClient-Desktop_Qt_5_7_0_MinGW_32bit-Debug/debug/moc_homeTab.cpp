...
#include "../../TeacherClient/homeTab.h"
...
QT_MOC_LITERAL(1, 8, 25), // "on_login_loginBtn_clicked"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "HomeTab\0on_login_loginBtn_clicked\0"
};
...
void HomeTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HomeTab *_t = static_cast<HomeTab *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_login_loginBtn_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject HomeTab::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HomeTab.data,
      qt_meta_data_HomeTab,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HomeTab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HomeTab.stringdata0))
        return static_cast<void*>(const_cast< HomeTab*>(this));
